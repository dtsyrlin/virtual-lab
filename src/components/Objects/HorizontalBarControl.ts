...
export interface HorizontalBarControlOptions {
...
export class HorizontalBarControl extends Container {
    ...
    private readonly sliderStartX = 80;
    ...
    constructor({
        ...
        for (
            ...
            /*
             * Ignore numeric positions
             * between 2 and min if min > 2.
             *
             * For our current use min is 2.
             */
            if (
                value >= 2 &&
                value < this.min
    ...
    private valueFromX(
        ...
        /*
         * If min were greater than 2,
         * skip unsupported numeric values.
         */
        if (
            value >= 2 &&
            value < this.min
    ...
    private updateSliderFromEvent(
        ...
        /*
         * Only fire when the slider
         * actually moves to another position.
         *
         * Therefore moving:
         *
         * RAND(0) -> RAND(1)
         *
         * still generates an event,
         * which allows the lab to create
         * another random bar.
         */
        if (
            newValue ===
